...
interface EditOnGithubButtonProps extends VariantProps<typeof buttonVariants> {
  filePath: string;
  className?: string;
  repository?: string;
...
export function EditOnGithubButton({
  ...
  return (
    ...
    <Link
      href={`https://github.com/${repository}/${filePath}`}
    ...
    >
      ...
      <span className="text-sm pr-1">View on GitHub</span>
    </Link>
    </Button>
  );
}